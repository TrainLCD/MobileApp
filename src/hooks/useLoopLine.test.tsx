...
describe('useLoopLine', () => {
  ...
  it('checkCurrentLine=false の場合、overrideStations から大阪環状線を検出', () => {
    const overrideStations: Station[] = [
      { id: 1162310, groupId: 1, line: { id: OSASA_LOOP_LINE_ID } }, // 大阪
      { id: 1162307, groupId: 2, line: { id: OSASA_LOOP_LINE_ID } }, // 西九条
      { id: 1162313, groupId: 3, line: { id: OSASA_LOOP_LINE_ID } }, // 京橋
      { id: 1162317, groupId: 4, line: { id: OSASA_LOOP_LINE_ID } }, // 鶴橋
      { id: 1162301, groupId: 5, line: { id: OSASA_LOOP_LINE_ID } }, // 天王寺
      { id: 1162302, groupId: 6, line: { id: OSASA_LOOP_LINE_ID } }, // 新今宮
    ] as unknown as Station[];
