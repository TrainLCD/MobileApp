...
const MirroringShareModal: React.FC<Props> = ({ visible, onClose }: Props) => {
  ...
  const handleShare = useCallback(async () => {
    const options = {
      ...
      url: `https://trainlcd.page.link/?link=https://trainlcd.app/adl/ms/${token}&apn=me.tinykitten.trainlcd&afl=https://trainlcd.app/&isi=1486355943&ibi=me.tinykitten.trainlcd&ifl=https://trainlcd.app/&efr=1`,
    };
