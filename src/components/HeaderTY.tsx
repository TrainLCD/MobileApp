...
const headerTy: React.FC = () => {
	...
	const headerLangState = useMemo(
		() =>
			headerState.split("_")[1]?.length > 0
		...
		<View>
			...
			>
				<View style={styles.headerTexts}>
					<TrainTypeBox isTY={true} trainType={trainType} />
					<View style={styles.boundWrapper}>
						...
						>
							...
							>
								{connectedLines?.length > 0 && isJapaneseState
									? `${connectionText}直通 `
									: null}
							</Text>
						...
						>
							<Text
								...
								style={styles.connectedLines}
							>
								{connectedLines?.length > 0 && prevIsJapaneseState
