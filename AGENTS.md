...
- Commit messages must be single-sentence, imperative statements (e.g., `Refactor telemetry sender to avoid null states`); prefix production hot fixes with `Hotfix:`.
