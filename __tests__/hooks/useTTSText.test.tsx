...
describe('Without trainType & With numbering', () => {
  ...
  describe('TOKYO_METRO Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        '次は<sub alias="シンジュクサンチョウメ">新宿三丁目</sub>です。この電車は、各駅停車、<sub alias="モトヤワタ"><sub alias="モトヤワタ">本八幡</sub></sub>ゆきです。',
  ...
  describe('TY Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        '次は<sub alias="シンジュクサンチョウメ">新宿三丁目</sub>です。<sub alias="トウキョウメトロマルノウチセン">東京メトロ丸ノ内線</sub>、<sub alias="トウキョウメトロフクトシンセン">東京メトロ副都心線</sub>をご利用のお客様はお乗り換えです。',
  ...
  describe('YAMANOTE Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        '次は<sub alias="シンジュクサンチョウメ">新宿三丁目</sub>、<sub alias="シンジュクサンチョウメ">新宿三丁目</sub>。<sub alias="トウキョウメトロマルノウチセン">東京メトロ丸ノ内線</sub>、<sub alias="トウキョウメトロフクトシンセン">東京メトロ副都心線</sub>はお乗り換えです。',
