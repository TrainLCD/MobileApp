  ...
  describe('TOKYO_METRO Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Please change here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      ...
      expect(result.current).toEqual([
        ...
        'Arriving at Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Please change here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
  })
  ...
  describe('TY Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next station is Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Passengers changing to the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line, Please transfer at this station.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        ...
        'We will soon make a brief stop at Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2.',
      ])
    })
  })
  ...
  describe('YAMANOTE Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next station is Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Please change here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
  ...
  describe('JR_WEST Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> station number <say-as interpret-as="characters">S</say-as> 2. Transfer here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        ...
        'We will soon be making a brief stop at Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> station number <say-as interpret-as="characters">S</say-as> 2. Transfer here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line. After leaving Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme>, We will be stopping at Akebonobashi.',
      ])
    })
  })
  ...
  describe('TOEI Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'This is the Local train bound for Motoyawata. The next station is Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Please change here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        ...
        'We will soon be arriving at Shinjuku<phoneme alphabet="ipa" ph="santyome">-sanchome</phoneme> <say-as interpret-as="characters">S</say-as> 2. Please change here for the Tokyo Metro Marunouchi Line, and the Tokyo Metro Fukutoshin Line.',
      ])
    })
  })
