  ...
  describe('TOKYO_METRO Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku-sanchome <say-as interpret-as="characters">S</say-as> 02.',
      ])
    })
    test('should be ARRIVING', () => {
      ...
      expect(result.current).toEqual([
        ...
        'Arriving at Shinjuku-sanchome, <say-as interpret-as="characters">S</say-as> 02.',
      ])
    })
  })
  ...
  describe('TY Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next station is Shinjuku-sanchome <say-as interpret-as="characters">S</say-as> 02. Passengers changing to the Tokyo Metro Marunouchi Line, Tokyo Metro Fukutoshin Line, Please transfer at this station.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        'まもなく<sub alias="しんじゅくさんちょうめ">新宿三丁目</sub>です。',
        'We will soon make a brief stop at Shinjuku-sanchome <say-as interpret-as="characters">S</say-as> 02.',
      ])
    })
  })
  ...
  describe('YAMANOTE Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next station is Shinjuku-sanchome <say-as interpret-as="characters">S</say-as> 02. Please change here for the Tokyo Metro Marunouchi Line and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
  ...
  describe('JR_WEST Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku-sanchome, station number <say-as interpret-as="characters">S</say-as> 02.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        ...
        'We will soon be making a brief stop at Shinjuku-sanchome, station number <say-as interpret-as="characters">S</say-as> 02. After leaving Shinjuku-sanchome.',
      ])
    })
  })
