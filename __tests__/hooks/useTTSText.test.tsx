...
describe('Without trainType & With numbering', () => {
  ...
  describe('TOKYO_METRO Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme> S 02.',
      ])
    })
    test('should be ARRIVING', () => {
      ...
      expect(result.current).toEqual([
        'まもなく、シンジュクサンチョウメです。',
        'Arriving at Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>, S 02.',
      ])
    })
  })
  ...
  describe('TY Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next station is Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>. Passengers changing to the Tokyo Metro Marunouchi Line, Tokyo Metro Fukutoshin Line, please transfer at this station.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        'まもなくシンジュクサンチョウメです。',
        'We will soon make a brief stop at Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>. The stop after Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>.',
      ])
    })
  })
  ...
  describe('YAMANOTE Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'This is the Toei Shinjuku Line train bound for Motoyawata. The next station is Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme> S 02. Please change here for the Tokyo Metro Marunouchi Line and the Tokyo Metro Fukutoshin Line.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
  ...
  describe('JR_WEST Theme', () => {
    test('should be NEXT', () => {
      ...
      expect(result.current).toEqual([
        ...
        'The next stop is Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>, station number S 02.',
      ])
    })
    test('should be ARRIVING', () => {
      const { result } = renderHook(
      ...
      expect(result.current).toEqual([
        ...
        'We will soon be making a brief stop at Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>, station number S 02. After leaving Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>.',
      ])
    })
  })
  ...
  describe('SAIKYO Theme', () => {
    ...
    test('should be ARRIVING', () => {
      ...
      expect(result.current).toEqual([
        'まもなく、シンジュクサンチョウメシンジュクサンチョウメ。東京メトロ丸ノ内線、東京メトロ副都心線は、お乗り換えです',
        'The next station is Shinjuku-san<phoneme alphabet="ipa" ph="tyome">chome</phoneme>, S 02. Please change here for the Tokyo Metro Marunouchi Line and the Tokyo Metro Fukutoshin Line.',
      ])
    })
  })
